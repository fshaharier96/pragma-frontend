...
import { FiArrowLeft, FiCheckCircle, FiPlus, FiSave, FiShoppingBag, FiTrash2 } from "react-icons/fi";
...
const CreatePurchase = () => {
  ...
  useEffect(() => {
    const loadOptions = async () => {
      ...
      try {
        ...
        setError("Supplier or product options could not be loaded.");
      } finally {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await axios.post(
        `${API_BASE_URL}/api/purchases/create`,
        {
          ...formData,
      ...
      setError(
        submitError.response?.data?.message ||
          "Purchase could not be created. Please check the details."
      );
    } finally {
      setSubmitting(false);
    }
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-500">
                    Create a purchase record and add product items from inventory.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="grid gap-5 md:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    readOnly
                    required
                    placeholder="Purchase number will be auto-generated"
                ...
                <div>
                  ...
                  <select
                    ...
                    className="mt-2 w-full rounded-lg border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-900 transition focus:border-blue-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-100 disabled:cursor-not-allowed disabled:text-slate-400"
                  >
              ...
              <div className="rounded-lg border border-slate-200">
                ...
                <div className="divide-y divide-slate-200">
                  {items.map((item, index) => {
                    ...
                    return (
                      <div key={index} className="grid gap-4 px-4 py-4 lg:grid-cols-[1.4fr_0.7fr_0.7fr_0.7fr_auto] lg:items-end">
                        <div>
