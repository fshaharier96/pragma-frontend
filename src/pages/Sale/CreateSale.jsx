...
import { FiArrowLeft, FiCheckCircle, FiPlus, FiSave, FiShoppingCart, FiTrash2 } from "react-icons/fi";
  ...
  useEffect(() => {
    const loadOptions = async () => {
      ...
      try {
        ...
        setError("Customer or product options could not be loaded.");
      } finally {
    ...
    try {
      ...
      setError(
        submitError.response?.data?.message ||
          "Sale could not be created. Please check the details."
      );
    } finally {
      setSubmitting(false);
    }
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-500">
                    Create a sale record and add product items from inventory.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="grid gap-5 md:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    required
                    readOnly
                    placeholder="Sale Number will be auto-generted"
